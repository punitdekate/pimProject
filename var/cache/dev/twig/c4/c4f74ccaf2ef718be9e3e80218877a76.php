...
class __TwigTemplate_35d4b4b8054c5089a6cbf658cb3fff95 extends Template
{
    private $source;
    private $macros = [];
  ...
  \t<div class=\"container-fluid\">
    ...
    <div class=\"collapse navbar-collapse\" id=\"navbarSupportedContent\">
      ...
      <form class=\"d-flex\" action=\"";
        // line 48
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("csearch");
        echo "\" method=\"POST\"> 
...
\t\t\t<button type=\"button\" class=\"btn btn-secondary btn-sm\" style=\"margin-right:5px\"> Apply Filter</button>
        \t<a href=\"gents\" class=\"btn btn-primary btn-sm active\" role=\"button\" aria-pressed=\"true\">Men</a>
        \t<a href=\"ladies\" class=\"btn btn-primary btn-sm active\" role=\"button\" aria-pressed=\"true\">Women</a>
        \t</div>
\t\t</div>
...
\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["objects"]) || array_key_exists("objects", $context) ? $context["objects"] : (function () { throw new RuntimeError('Variable "objects" does not exist.', 67, $this->source); })()));
    ...
    \t\t<div style=\"border:solid black;margin-top:20px;\"align=\"center;\">
        \t    <img class=\"rounded mx-auto d-block\" src=\"";
            // line 70
            echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["object"], "getProductImage", [], "method", false, false, true, 70), 70, $this->source), "html", null, true);
            echo "\"style=\"height:300px; width:300px;margin-top:20px;\" align=\"center\"/><br>
              <h3 align=\"center\"style=\"color:Black\">Brand :";
            // line 71
            echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["object"], "getBrandName", [], "any", false, false, true, 71), 71, $this->source), "html", null, true);
            echo " </h3>
            \t<h4 align=\"center\"style=\"color:Black\">Price :";
            // line 72
            echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["object"], "getPrice", [], "any", false, false, true, 72), 72, $this->source), "html", null, true);
            echo " </h4>
            \t<p style=\"height:100px; widht:100px;margin-top:20px;\" align=\"center\" >
\t               ";
            // line 74
            echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["object"], "getDescription", [], "method", false, false, true, 74), 74, $this->source), "html", null, true);
            echo " </p>
    \t     </div>
      \t</div>
    \t";
    ...
    {
        return array (  149 => 79,  139 => 74,  134 => 72,  130 => 71,  126 => 70,  122 => 68,  118 => 67,  108 => 59,  95 => 48,  66 => 21,  45 => 1,);
    }
...
\t{# header code #}
  ...
  \t<div class=\"container-fluid\">
    ...
    <div class=\"collapse navbar-collapse\" id=\"navbarSupportedContent\">
      ...
      <form class=\"d-flex\" action=\"{{ path('csearch') }}\" method=\"POST\"> 
        <input class=\"form-control me-2\" name=\"search\" type=\"search\" placeholder=\"Search\" aria-label=\"Search\">
        <button class=\"btn btn-outline-success\" type=\"submit\">Search</button>
        </input>
      </form>
