...
class __TwigTemplate_93b7c0ae25a0873dd594b8e93fe3f4d3 extends Template
{
    private $source;
    private $macros = [];
    ...
    {% for trackedCode in trackedCodes %}
        {{ trackedCode | raw }}
    {% endfor %}
</script>", "@PimcoreCore/Analytics/Tracking/GoogleTagManager/dataLayer.html.twig", "/var/www/html/firstproject/pimProject/vendor/pimcore/pimcore/bundles/CoreBundle/Resources/views/Analytics/Tracking/GoogleTagManager/dataLayer.html.twig");
    }
