...
class __TwigTemplate_07de3552a4d5169de39d14ffa52122d6 extends Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"container-fluid\">
    ...
    <div class=\"collapse navbar-collapse\" id=\"navbarSupportedContent\">
      ...
      <form class=\"d-flex\" action=\"";
        // line 51
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("bsearch");
        echo "\" method=\"POST\"> 
...
\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["objects"]) || array_key_exists("objects", $context) ? $context["objects"] : (function () { throw new RuntimeError('Variable "objects" does not exist.', 73, $this->source); })()));
    ...
    \t<div style=\"border:solid black;margin-top:20px;\"align=\"center;\">
        \t    <img class=\"rounded mx-auto d-block\" src=\"";
            // line 76
            echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["object"], "getProductImage", [], "method", false, false, true, 76), 76, $this->source), "html", null, true);
            echo "\"style=\"height:300px; width:300px;margin-top:20px;\" align=\"center\"/><br>
              <h3 align=\"center\"style=\"color:Black\">Brand :";
            // line 77
            echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["object"], "getBrandName", [], "any", false, false, true, 77), 77, $this->source), "html", null, true);
            echo " </h3>
            \t<h4 align=\"center\"style=\"color:Black\">Price :";
            // line 78
            echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["object"], "getPrice", [], "any", false, false, true, 78), 78, $this->source), "html", null, true);
            echo " </h4>
            \t<p style=\"height:100px; widht:100px;margin-top:20px;\" align=\"center\" >
\t               ";
            // line 80
            echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["object"], "getDescription", [], "method", false, false, true, 80), 80, $this->source), "html", null, true);
            echo " </p>
    \t     </div>
      \t</div>
    \t";
...
";
    ...
    {
        return array (  160 => 88,  155 => 84,  145 => 80,  140 => 78,  136 => 77,  132 => 76,  128 => 74,  124 => 73,  110 => 61,  98 => 51,  66 => 21,  45 => 1,);
    }
...
{# header code #}
  ...
  <div class=\"container-fluid\">
    ...
    <div class=\"collapse navbar-collapse\" id=\"navbarSupportedContent\">
      ...
      <form class=\"d-flex\" action=\"{{ path('bsearch') }}\" method=\"POST\"> 
        <input class=\"form-control me-2\" name=\"search\" type=\"search\" placeholder=\"Search\" aria-label=\"Search\">
        <button class=\"btn btn-outline-success\" type=\"submit\">Search</button>
        </input>
      </form>
